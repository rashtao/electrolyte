...
Container.prototype.create = function (id, parent, stack) {
    ...
    // TODO: skip test in case of setterInjection
    if (stack.indexOf(id) >= 0) {
        throw new Errors.RecursiveDependencyFound(id, stack.join(" --> "));
    }
    ...
    throw new Errors.DependencyNotFound(id, stack.join(Container.nestedResourcesSeparator));
};
...
Container.prototype.createOpt = function (id, parent, stack) {
    ...
    try {
        ...
        if (e instanceof Errors.DependencyNotFound) {
...
Container.prototype._create = function (id, parent, stack) {
    ...
    log.info("Component.create", stack);
