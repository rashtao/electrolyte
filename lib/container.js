...
Container.prototype.register = function (id, module, dependencies, mode) {
	...
	if (mode == "@singleton") {
		if (explicitDeps) {
			return this.singleton(id, dependencies, module);
		} else {
			return this.singleton(id, module);
		}
	} else if (mode == "@factory") {
		if (explicitDeps) {
			return this.factory(id, dependencies, module);
		} else {
			return this.factory(id, module);
		}
	} else if (mode == "@constructor") {
		if (explicitDeps) {
			return this.constructor(id, dependencies, module);
		} else {
			return this.constructor(id, module);
		}
	} else if (mode == "@literal") {
		if (explicitDeps) {
			return this.literal(id, dependencies, module);
		} else {
